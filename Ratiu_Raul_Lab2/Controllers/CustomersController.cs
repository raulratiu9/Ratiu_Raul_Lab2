...
namespace Ratiu_Raul_Lab2.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        {
            var libraryContext = _context.Customers.Include(c => c.City);
        ...
        public async Task<IActionResult> Create([Bind("CustomerID,CityID,Name,Adress,BirthDate")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerID,CityID,Name,Adress,BirthDate")] Customer customer)
        {
